...
export function createIpoFilingsFeed({
  ...
  return {
    ...
    startLive: (live) => { live.register('ipo-filings', { intervalMs: IPO_POLL_MS, fetcher: async () => { await refresh(); return { failed: meta().degraded ? 1 : 0 }; } }); live.start('ipo-filings', { fresh: true }); },
