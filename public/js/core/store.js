...
const reconstructible = key => /^(filings:news(?::|$)|news-history:|snapshot:tradingview-news$|market-news(?::|$)|(?:all-alerts:public-pool|ai-alerts:public-window):|news-query:|mf:|mf-detail:|mf-snapshot:)/.test(key);
