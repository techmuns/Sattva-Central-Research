...
Neither a process restart nor another workflow run bypasses that budget. Source
...
pages or observations are uploaded as public artifacts or committed snapshots.
...
layout are retained; source links identify MF Scanner observations.
