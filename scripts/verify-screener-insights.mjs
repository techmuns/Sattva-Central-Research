...
assert.equal(enrichCardFromAllAlerts(card, { ...report, events: [{ ...candidateNews, attribution: { version: ATTRIBUTION_VERSION, status: 'confirmed' } }] }).contextEvents.length, 1);
assert.equal(enrichCardFromAllAlerts(card, { ...report, events: [{ ...candidateNews, attribution: { version: ATTRIBUTION_VERSION, status: 'uncertain' } }] }).contextEvents.length, 0);
